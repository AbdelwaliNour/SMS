  ...
  return (
    <header className="bg-white dark:bg-gray-900 border-b border-divider dark:border-gray-700 py-4 px-6 flex items-center justify-between">
      ...
      <div className="relative w-96">
        ...
        />
        <button className="absolute right-3 top-2.5 text-blue">
      ...
      <div className="text-right">
        <p className="text-gray-800 dark:text-gray-200">{formattedTime}</p>
        <p className="text-gray-500 dark:text-gray-400 text-sm">{formattedDate}</p>
      </div>
      
      {/* Action Buttons */}
      <div className="flex items-center space-x-4">
        <Button size="icon" className="w-8 h-8 rounded-full bg-blue hover:bg-blue/90 text-white">
