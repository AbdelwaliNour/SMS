    ...
    <Layout>
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="glass-morphism border-blue-400 dark:border-blue-400/70 bg-gradient-to-br from-blue-200 via-blue-100 to-cyan-200 dark:from-blue-700/40 dark:via-blue-600/40 dark:to-cyan-700/40 shadow-lg shadow-blue-500/30">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-blue-900 dark:text-blue-100">Total Records</CardTitle>
              <ClipboardList className="h-5 w-5 text-blue-800 dark:text-blue-200" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-blue-900 dark:text-white">{attendanceStats.total}</div>
          ...
          <Card className="glass-morphism border-emerald-400 dark:border-emerald-400/70 bg-gradient-to-br from-emerald-200 via-green-100 to-emerald-200 dark:from-emerald-700/40 dark:via-green-600/40 dark:to-emerald-700/40 shadow-lg shadow-emerald-500/30">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-emerald-900 dark:text-emerald-100">Present</CardTitle>
              <CheckCircle className="h-5 w-5 text-emerald-800 dark:text-emerald-200" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-emerald-900 dark:text-white">{attendanceStats.present}</div>
          ...
          <Card className="glass-morphism border-amber-400 dark:border-amber-400/70 bg-gradient-to-br from-amber-200 via-yellow-100 to-amber-200 dark:from-amber-700/40 dark:via-yellow-600/40 dark:to-amber-700/40 shadow-lg shadow-amber-500/30">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-amber-900 dark:text-amber-100">Late Arrivals</CardTitle>
              <Clock className="h-5 w-5 text-amber-800 dark:text-amber-200" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-amber-900 dark:text-white">{attendanceStats.late}</div>
          ...
          <Card className="glass-morphism border-red-400 dark:border-red-400/70 bg-gradient-to-br from-red-200 via-rose-100 to-red-200 dark:from-red-700/40 dark:via-rose-600/40 dark:to-red-700/40 shadow-lg shadow-red-500/30">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-red-900 dark:text-red-100">Absent</CardTitle>
              <XCircle className="h-5 w-5 text-red-800 dark:text-red-200" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-red-900 dark:text-white">{attendanceStats.absent}</div>
